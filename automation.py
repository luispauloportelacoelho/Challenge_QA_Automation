...
def newAdvertNotLogged():
    ...
    try:
        ...
        browser.save_screenshot('errorNewAdvertNotLogged.png')
...
def registerNewUser():
    ...
    try:
        ...
        browser.save_screenshot('errorRegisterNewUser.png')
...
def activateNewUser():
    ...
    try:
        ...
        browser.save_screenshot('errorActivateNewUser.png')
...
def newAdvert():
    ...
    #try:
        ...
        # save
        browser.find_element_by_xpath('//*[@id="save"]').click()
        browser.find_element_by_xpath('//*[@id="smsVerificationStep1Form"]/fieldset/div/div/input[2]').send_keys(
            '910000000')
...
def editUser():
    ...
    try:
        ...
        webdriver.ActionChains(browser).move_to_element(
            browser.find_element_by_xpath('//*[@id="topLoginLink"]/span')).perform()
        time.sleep(5)

        # settings
        webdriver.ActionChains(browser).move_to_element(
            browser.find_element_by_xpath('//*[@id="login-box-settings"]/span')).click().perform()
        time.sleep(2)
        ...
        browser.save_screenshot('errorEditUser.png')
...
def loginLogout():
    ...
    try:
        ...
        # logOut
        webdriver.ActionChains(browser).move_to_element(
            browser.find_element_by_xpath('//*[@id="login-box-logout"]/span/span')).click().perform()
